...
//				});
				...
				GameFrame frame = new GameFrame(username, score);
...
//						addData(data);
//					}
					JOptionPane.showMessageDialog(StartFrame.this,"Hi "+ username + " your max score is: " + score,"Info",JOptionPane.INFORMATION_MESSAGE);
				}
